...
const fn measurement_to_enu(measurement: Measurement) -> Measurement {
    Measurement {
        x: -measurement.y,
        y: -measurement.x,
        z: measurement.z,
...
const fn enu_to_cartesian(measurement: Measurement) -> Measurement {
    Measurement {
        x: -measurement.y,
        y: measurement.x,
        z: measurement.z,
...
pub const fn calibrated_measurement(
